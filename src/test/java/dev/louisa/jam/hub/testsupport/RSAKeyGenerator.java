...
public class RSAKeyGenerator {
    ...
    private static final String KEY_BUNDLE_FILE_LOCATION = "auth-server/src/main/resources/keys/";
    ...
    /**
     * This utility method generates a new pair of keys, private key (PKCS#8) / public key(X.509), and outputs creates 
     * the key pair bundle files in the 'resources/keys' folder.
     * This class has been located in the test java packages because we don't want to deploy an ordinary class with a 
     * 'main' method to production. (This class should also not be used as part of your production code!!!)
     **/
